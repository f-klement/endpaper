...
export default function HelpButton({ label, onClick }: HelpButtonProps) {
  ...
  return (
    <button
      ...
      aria-label={label}
      title={t("help.title")}
      className="shrink-0 w-5 h-5 rounded-full border border-paper-300 text-paper-600 text-xs font-semibold leading-none hover:border-accent-400 hover:text-accent-700 transition-colors dark:text-paper-400 dark:hover:text-accent-300"
    >
