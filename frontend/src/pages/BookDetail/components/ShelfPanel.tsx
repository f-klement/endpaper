    ...
    <form onSubmit={submit} className="space-y-3">
      ...
      <div className="flex gap-2">
        <input
          ...
          className="flex-1 px-3 py-2 rounded-xl border border-gray-200 text-sm focus:outline-none focus:ring-2 focus:ring-sky-400 dark:border-gray-700"
        />
        <input
          type="number"
          step="0.5"
          ...
          className="w-20 px-3 py-2 rounded-xl border border-gray-200 text-sm focus:outline-none focus:ring-2 focus:ring-sky-400 dark:border-gray-700"
        />
      </div>

      <h2 className="text-sm font-semibold text-gray-900 pt-1 dark:text-gray-100">
        {t("location.label")}
      </h2>
      <input
        type="text"
        ...
        className="w-full px-3 py-2 rounded-xl border border-gray-200 text-sm focus:outline-none focus:ring-2 focus:ring-sky-400 dark:border-gray-700"
      />
      ...
      {dirty && (
        <button
          type="submit"
          disabled={isSaving}
          className="w-full py-2 rounded-xl bg-sky-500 text-white text-sm font-medium hover:bg-sky-600 disabled:opacity-50 transition-colors"
        >
