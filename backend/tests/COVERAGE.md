...
**2501 tests**, in 56 files. Line coverage was last measured at **96%** (4303 statements,
...
| `test_notifications.py` | 46 | **The overdue digest.** Selection and the reminder interval, that a private book never reaches the wire, the signature, redirects refused, and that a failure leaves the loan to retry |
