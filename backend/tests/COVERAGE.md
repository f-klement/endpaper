...
**6921 tests**, in 103 files, recounted with `--collect-only` on 2026-09-11.
...
**The rows below sum to 6872, forty nine short, and the shortfall is deliberate.** Those
