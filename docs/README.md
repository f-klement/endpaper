...
| [theming.md](theming.md) | The seven palettes and the rule that generated them, the ten wallpapers and the rule that admits them, and where an appearance is stored |
