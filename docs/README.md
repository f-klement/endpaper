...
National Library of Greece, the Austrian National Library and Google Books as fallbacks.
Google Books needs a key you supply, so a stock install runs the other six.
