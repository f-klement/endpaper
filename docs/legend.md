...
| **LCSH** | Library of Congress Subject Headings. Not a classification: a controlled vocabulary of subject *phrases*, served from `id.loc.gov`. |
...
| **Koha** | Not an acronym, a Maori word. The long established open source ILS, read here as a reference for the public library mode design. What its licence does and does not permit is settled in `implementation_plan.md` under 30e and 30h. |
